    ...
    class Data
    {
        ...
        public string this[string index]
        {
            ...
            set
            {
                ...
                { // Key already exists, so change entry rather than create.
        ...
        {
            // Define a function to remove an entry from the stored dictionary.
            // Removes the given key (and associated password).
            // Will do nothing if try to remove a non-existent key.
